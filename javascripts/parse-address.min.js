  ...
  })()(
    {
          ...
          (function() {
            ...
            parser.normalize_address = function(parts) {
              ...
              if (parsed.city) {
                parsed.city = XRegExp.replace(
                  parsed.city,
                  XRegExp(
                    '^(?<dircode>' + Addr_Match.dircode + ')\\s+(?=\\S)',
                    'ix'
                  ),
                  function(match) {
                    return (
                      capitalize(Direction_Code[match.dircode.toUpperCase()]) +
                      ' '
                    );
                  }
                );
            ...
            parser.parseIntersection = function(address) {
              ...
              if (parts) {
                ...
                if (
                  (parts.type2 && !parts.type1) ||
                  parts.type1 === parts.type2
                ) {
      ...
      2: [
        function(require, module, exports) {
          ...
          var features = { astral: false, natives: false };
          var nativ = {
          ...
          fixed.exec = function(str) {
            ...
            if (match) {
              if (
                ...
                r2 = copyRegex(this, { removeG: true, isInternalOnly: true });
                nativ.replace.call(
